            ...
            <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 m-10 mt-20 text-lg text-[#1c1917] text-center sm:flex-row sm:space-y-0 sm:space-x-4">
                    ...
                    >
                        ...
                        <span className="font-semibold text-[#040240] hover:text-[#0f172a]">+37477122212</span>
                    </Link>
                    <span>{Texts.or}</span>
                </div>
                <button
                    type="submit"
                    className="block w-full sm:w-auto py-3 px-6 text-center rounded-xl transition bg-[#040240] hover:bg-[#0f172a] mx-auto"
