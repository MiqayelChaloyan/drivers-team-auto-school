        ...
        <div className="bg-white">
            ...
            >
                <div className="mx-auto max-w-7xl px-5 py-16 md:px-10 md:py-20">
                    <h1 className="mb-6 max-w-3xl text-white text-4xl font-bold md:mb-10 md:text-6xl lg:mb-12">
                        {description}
                    </h1>
                </div>
            </div>
            <div className="mx-auto max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
                <div className="relative flex max-w-7xl flex-col gap-4 lg:flex-row lg:justify-end">
                    ...
                    <img
                        src={path?.src}
                        alt={image?.alt}
                        className="relative bottom-0 right-0 mt-12 w-[450px] object-cover lg:absolute lg:mt-0 lg:h-[550px]"
                    />
                </div>
            </div>
        </div>
