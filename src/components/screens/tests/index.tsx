...
const Tests = () => {
    ...
    return (
        <section className="py-12 bg-gray-400 text-gray-100 sm:py-12 lg:py-16">
                    ...
                    {tests?.map((_: any, index: number) => (
                        ...
                        >
                            <div className={`relative overflow-hidden bg-white shadow-md rounded-xl h-30`}>
                                <div className="p-5">
                                    <h2 className="mt-1 text-3xl font-bold text-gray-900 sm:mt-1">{index + 1}</h2>
                                    <h3 className="mt-5 text-2xl font-bold text-gray-900 sm:mt-5">Թեստ</h3>
                                </div>
                            </div>
                        </Link>
                    ))}
