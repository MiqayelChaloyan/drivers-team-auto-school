...
const Header = () => {
    return (
        ...
        //             <h1 className="text-3xl lg:text-4xl font-bold leading-9 text-gray-800 pb-4">Մեր Մասին</h1>
        ...
        // </div>
        <>
            <section className="overflow-hidden pt-20 pb-12 lg:pt-[10px] lg:pb-[90px] bg-white dark:bg-dark">
                <div className="container mx-auto">
                    <div className="flex flex-wrap items-center justify-between -mx-1">
